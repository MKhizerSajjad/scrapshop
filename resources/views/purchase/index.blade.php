                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="d-flex justify-content-end gap-2" bis_skin_checked="1">
                                <a href="{{ route('purchase.create') }}" class="btn btn-primary waves-effect waves-light"> <i class="bx bx-plus me-1"></i> Add New</a>
                            </div>
                                        ...
                                        <tbody>
                                            @foreach ($data as $key => $purchase)
                                                <tr>
                                                    ...
                                                    <td class="text-center"> <a href="{{ route('purchase.edit', $purchase->id) }}"><i class="bx bx-pencil"></i></a></td>
                                                </tr>
                                            @endforeach
                                        </tbody>
                                    </table>
