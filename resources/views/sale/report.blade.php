                    ...
                    <form method="GET" action="{{ route('sale.report') }}">
                        <div class="row mb-2">
                            ...
                            <div class="col-sm-2 mt-4">
                                ...
                                <a href="{{ route('sale.report') }}" class="waves-effect waves-light btn btn-secondary"><i class="bx bx-crosshair me-1"></i> Clear</a>
                            </div>
                        </div>
                    </form>
                </div>
                                    ...
                                    <table class="table mb-0 table">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-end font-size-18">{{ $totalSale }}</td>
                                            </tr>
                                        </tbody>
                                    </table>
                                    {{ $data->links() }}
